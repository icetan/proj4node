 ...
 */
     ...
     */
    // TODO: not loading any weird scripts!
...
Proj4js.Proj = Proj4js.Class({
  ...
  */
  initialize: function(def) {
      ...
      // TODO: no support for WKT right now.
      ...
      // TODO: no support for auto loading definitions
      ...
      this.parseDefs(def);
      Proj4js.extend(this, Proj4js.Proj[this.projName] || require('./projCode/'+this.projName));
      this.init();
  },
 ...
 *
 */
    // TODO: no loading from external services!
 ...
 *
 */
    // TODO: caching defs is not your job!
 ...
 *
 */
    // TODO: no loading stuff off site plz.
...
Proj4js.WGS84 = new Proj4js.Proj("+title=WGS 84 (long/lat) +proj=longlat +ellps=WGS84 +datum=WGS84 +units=degrees");
